...
class Config:
    ...
    BOT_TOKEN = environ.get("BOT_TOKEN", "8032047153:AAHRBS4AXkjCrX1tllknb2p12wgwI6dInUg") 
    ...
    BOT_OWNER_ID = [int(id) for id in environ.get("BOT_OWNER_ID", '7016105736').split()]
    LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002312610528'))
    FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "https://t.me/Movies_Squid_Game") 
